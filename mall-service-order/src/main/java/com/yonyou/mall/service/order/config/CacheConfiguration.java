...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mallServiceOrder");
        ...
        config.setInstanceName("mallServiceOrder");
        ...
        config.getMapConfigs().put("com.yonyou.mall.service.order.domain.*", initializeDomainMapConfig(jHipsterProperties));
