...
@SpringBootTest(classes = {MallServiceCatalogApp.class, SecurityBeanOverrideConfiguration.class})
public class ProductResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_INVENTORY = new BigDecimal(0);
    private static final BigDecimal UPDATED_INVENTORY = new BigDecimal(1);
